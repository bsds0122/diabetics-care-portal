...
import { PersonalInfoSection } from "@/pages/doctor/components/Patients/PersonalInfoSection";
import { LocationInfoSection } from "@/pages/doctor/components/Patients/LocationInfoSection";
