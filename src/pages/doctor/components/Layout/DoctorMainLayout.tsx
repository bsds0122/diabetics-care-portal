...
import { AppSidebar } from "@/pages/doctor/components/Layout/AppSidebar";
import { Header } from "@/pages/doctor/components/Layout/Header";
import { Footer } from "@/pages/doctor/components/Layout/Footer";
import { Outlet } from "react-router-dom";

/* ✅ IMPORT FROM NEW FILE */
import { doctorProfile, handleSignOut } from "@/lib/doctorProfile";
